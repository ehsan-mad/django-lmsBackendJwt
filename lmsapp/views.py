...
from .serializers import (RegisterSerializer,LoginSerializer, TeacherSerializer, StudentSerializer,CourseSerializer,EnrollmentSerializer,LessonSerializer,AssignmentSerializer,SubmissionSerializer)

from .models import (Profile, Teacher, Student, Course, Enrollment, Lesson, Assignment,Submission)
